...
namespace backEndCapstone.Controllers
{
    public class RacesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RaceId,CharacterId,RaceType,RacialAbilities,Speed")] Race race)
        {
            ModelState.Remove("CharacterId");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RaceId,CharacterId,RaceType,RacialAbilities,Speed")] Race race)
        {
            if (id != race.RaceId)
            {
                return NotFound();
